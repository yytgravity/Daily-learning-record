//
// Created by YYT on 2020/5/10.
//
#ifndef YYT_STL_STL_VECTOR_H
#define YYT_STL_STL_VECTOR_H
...
//当要增加的空间大于备用空间，则需要该函数配置新的vector空间，该操作会释放掉之前的空间，并将之前的内容copy到新的空间。
        ...
        void swap(vector<_Tp, _Alloc> &__x) {
            if (this != &__x) {
                yyt_stl::swap(_M_start, __x._M_start);
                yyt_stl::swap(_M_finish, __x._M_finish);
                yyt_stl::swap(_M_end_of_storage, __x._M_end_of_storage);
            }
        }
